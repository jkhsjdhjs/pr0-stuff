// ==UserScript==
// @name        IMG/Old Link Lookup
// @author      jkhsjdhjs
// @namespace   jkhsjdhjs
// @description Optionale Weiterleitung bei IMG/VID Links (img/vid.pr0gramm.com) zum Post und Konvertierung alter Links (pr0gramm.com/#newest/) - z.B. in den Kommentaren - ins neue Format.
// @include     *pr0gramm.com*
// @version     1.10
// @updateURL	https://totally.rip/pr0/img_old_link_lookup.user.js
// @downloadURL	https://totally.rip/pr0/img_old_link_lookup.user.js
...
function ajaxCall() {
	...
	xhr = $.ajax({
		type: 'GET',
		dataType: 'json',
		url: 'https://totally.rip/pr0/img_reverse_lookup.php',
...
function code() {
	if(RegExpIMG.test(location.href)) {
		if($('img').length || $('video').length) {
			$('body').append('<a href="#" id="a_arrow"><img id="arrow" title="Zum Post" src="https://totally.rip/pr0/arrow.png"></a>');
			$('#arrow').css({
				'height': '75px',
				'width': '75px'
			});
